...
> 项目路径: `/home/huhu/workspace/xiaohongshu-skills`
> CLI 命令: `/home/huhu/.local/bin/uv run python scripts/cli.py <子命令>`
> 首次使用前先启动 Chrome: `python scripts/chrome_launcher.py`
